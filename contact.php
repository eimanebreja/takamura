            ...
            <div class="contact-container">
                <form action="">
                    <div class="contact-area">
                        <div class="contact-label label-center">
                            氏名
                        </div>
                        <div class="contact-input-md">
                            <input class="input-form" type="text" placeholder="姓">
                        </div>
                        <div class="contact-input-md">
                            <input class="input-form" type="text" placeholder="名">
                        </div>
                        <div class="contact-label label-center">
                            カナ
                        </div>
                        <div class="contact-input-md">
                            <input class="input-form" type="text" placeholder="セイ">
                        </div>
                        <div class="contact-input-md">
                            <input class="input-form" type="text" placeholder="メイ">
                        </div>

                        <div class="contact-label label-center">
                            メールアドレス
                        </div>
                        <div class="contact-input-lg">
